...
<head>
    ...
    <title>Найди пропущенный - Buildle.gg</title>
    <link rel="stylesheet" href="${pageContext.request.contextPath}/css/layout.css">
    <link rel="stylesheet" href="${pageContext.request.contextPath}/css/challenge.css">
    <script src="${pageContext.request.contextPath}/js/missing-challenge.js" defer></script>
</head>
<body>
<div class="container">
    <header>
    ...
    <main class="challenge-page">
        ...
        <div class="challenge-content">
            ...
            <div class="guess-section">
                ...
                <form action="${pageContext.request.contextPath}/guess/missing" method="post" class="guess-form">
