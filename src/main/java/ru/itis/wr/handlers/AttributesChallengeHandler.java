...
public class AttributesChallengeHandler extends BaseChallengeHandler implements ChallengeHandler {
    private final ChallengeService challengeService;

    public AttributesChallengeHandler(ChallengeService challengeService) {
