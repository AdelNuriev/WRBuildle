...
public class MissingChallengeHandler extends BaseChallengeHandler implements ChallengeHandler {
    private final ChallengeService challengeService;

    public MissingChallengeHandler(ChallengeService challengeService) {
